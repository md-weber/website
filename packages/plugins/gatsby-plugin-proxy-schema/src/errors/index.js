module.exports = vars => ({
  ...
  deprecated_source_plugin: `Deprecated sourcing plugin detected: ${vars.installedPlugin}@${vars.installedPlugin} - Minimum required version is ${vars.installedPlugin}@${vars.source}. Please upgrade the sourcing plugin. See: ${vars.source.sourcePluginVersionGuide}`
})
