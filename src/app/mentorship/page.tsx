...
const mentorshipFAQ: FAQProps["faqItems"] = [
  {
    title:
      "Is the mentorship program suitable for a Flutter developer already employed at a software company?",
  ...
  {
    title:
      "I'm a beginner in Flutter development, is this mentorship program right for me?",
  ...
  {
    title:
      "What kind of time commitment is expected for this mentorship program?",
    ...
    <div className={"m-auto prose dark:prose-invert prose-xl"}>
      ...
      <section className="mt-6">
        ...
        <p className="my-2 text-gray-600 dark:text-gray-400">
          Welcome to the Full-Stack Mastery Program, a mentorship journey
          designed with you in mind. In this unique mentorship program,
          you&apos;ll be taken on an immersive journey to become a proficient
          Full Stack Developer under my guidance. As an industry expert with
          several years of experience across various programming frameworks and
          languages, my mission is to provide you with the tools, knowledge, and
          confidence to thrive in your career as a developer.
        </p>
        ...
        <p className={"mt-2 text-gray-600 dark:text-gray-400"}>
          Whether you&apos;re seeking to elevate your existing skills or making
          a career transition, this mentorship program is designed to set you on
          the path to success in the world of Full Stack Development. Together,
      ...
      <section className="mt-6">
        <h3 className="text-2xl font-semibold text-gray-800 dark:text-gray-200">
          Mentorship Program Packages
        </h3>
        <MentorshipTiers />
      </section>

      <h3 className="text-2xl font-semibold text-gray-800 dark:text-gray-200 py-2">
          ...
          <figure className="max-w-screen-md mx-auto">
            ...
            <blockquote>
              <p className="text-2xl font-medium text-gray-900 dark:text-white">
                &quot;I am super happy to have Max as my coding mentor. He has a
                vast amount of knowledge not only regarding flutter, but also
                about software engineering in general.
                <br />
                <br />
                Working with him on my personal projects has improved my
                developer skills tremendously. Knowing that I consistently get
                high quality feedback helps me stay motivated and overcome
                roadblocks. I whole heartedly recommend Max as a mentor!&quot;
              </p>
            </blockquote>
      ...
      <section className="mt-6">
        <h3 className="text-2xl font-semibold text-gray-800 dark:text-gray-200 pb-4">
